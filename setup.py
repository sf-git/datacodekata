...
setuptools.setup(
    ...
    package_data={"dck_problem1": ["py.typed"]},
    ...
    entry_points={
        "console_scripts": [
            "csv_cli=dck_problem1.csv_cli:main",
            "fwf_cli=dck_problem1.fwf_cli:main",
        ]
    },
)
